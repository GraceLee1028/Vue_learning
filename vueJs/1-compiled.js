...
const vm = new Vue({
    ...
    data: {
        ...
        infoObj: [{ id: "10002", name: "June", age: 25, sex: 1, add: "四川" }, { id: "10001", name: "lea", age: 23, sex: 0, add: "湖北" }, { id: "10003", name: "Anna", age: 26, sex: 1, add: "上海" }, { id: "10004", name: "John", age: 22, sex: 0, add: "重庆" }, { id: "10005", name: "Joe", age: 21, sex: 1, add: "北京" }, { id: "10006", name: "Jane", age: 23, sex: 1, add: "武汉" }],
        colorArr: ["红", "绿", "蓝", "黄"],
        comObj: {
            "name": "智能商务有限公司",
            "address": "深大",
